...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.03.03, September 17, 2023 08:04:20):
...
app_logger.info(f'Created September 17, 2023 08:04:20 at {str(current_path)}\n')
